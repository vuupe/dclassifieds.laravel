        ...
        <div class="container ad_detail_container">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div><a href="" id="show_hide_ad">show ad</a></div>
                        ...
                        <div class="col-md-12">
                            <form method="POST">
                                ...
                                <div class="form-group required {{ $errors->has('contact_name') ? ' has-error' : '' }}">
                                	...
                                	<input type="text" class="form-control" id="contact_name" name="contact_name" value="{{ old('contact_name') }}" maxlength="255"/>
                                ...
                                <div class="form-group required {{ $errors->has('contact_mail') ? ' has-error' : '' }}">
                                    <label for="contact_mail" class="control-label">Your E-Mail</label>
                                	<input type="text" class="form-control" id="contact_mail" name="contact_mail" value="{{ old('contact_mail') }}" maxlength="255"/>
