...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">{{ trans('admin_common.Pages') }}</li>
        </ol>
    </section>
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('admin_common.All Pages') }}</h3>
        </div>
        <!-- /.box-header -->

        <form method="post" name="list_form" id="list_form" action="{{ url('admin/page/delete') }}">
        {!! csrf_field() !!}
            ...
            <div class="controls">
                ...
                <a href="{{ url('admin/page/edit') }}" class="btn btn-primary btn-sm"><i class="fa fa-file-o"></i> {{ trans('admin_common.New Page') }}</a>
            </div>
                ...
                <table id="list_table" class="table table-bordered table-striped table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>{{ trans('admin_common.Page Title') }}</th>
                            <th>{{ trans('admin_common.Page Position') }}</th>
                            <th>{{ trans('admin_common.Active') }}</th>
                            <th>{{ trans('admin_common.Page Order') }}</th>
                            <th></th>
                            <th></th>
                        </tr>
                    </thead>
