...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Car Conditions</li>
        </ol>
    </section>
    ...
    <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">All Car Conditions</h3>
        ...
        {!! csrf_field() !!}
            ...
            <div class="controls">
                ...
                <a href="{{ url('admin/carcondition/edit') }}" class="btn btn-primary btn-sm"><i class="fa fa-file-o"></i> New Car Condition</a>
            </div>
            ...
            <tbody>
                <?foreach($modelData as $k => $v){?>
                    <tr>
                        ...
                        <td><a href="{{ url('admin/carcondition/edit/' . $v['car_condition_id']) }}"><i class="fa fa-edit"></i> Edit</a></td>
                        <td><a href="{{ url('admin/carcondition/delete/' . $v['car_condition_id']) }}" class="text-danger need_confirm"><i class="fa fa-trash"></i> Delete</a></td>
                    </tr>
                <?}//end of foreach?>
            </tbody>
            </table>
