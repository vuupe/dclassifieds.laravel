...
@section('content')
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('admin_common.All Reports') }}</h3>
        </div>
        <!-- /.box-header -->

        <form method="post" name="list_form" id="list_form" action="{{ url('admin/report/delete') }}">
        {!! csrf_field() !!}
                ...
                <table id="list_table" class="table table-bordered table-striped table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>{{ trans('admin_common.Report Date') }}</th>
                            <th>{{ trans('admin_common.Report Type') }}</th>
                            <th>{{ trans('admin_common.Report Ad Id') }}</th>
                            <th>{{ trans('admin_common.Report User Id') }}</th>
                            <th>{{ trans('admin_common.Report Info') }}</th>
                            <th></th>
                        </tr>
                    </thead>
                    <tbody>
