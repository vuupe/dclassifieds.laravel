...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">{{ trans('admin_common.Car Brands') }}</li>
        </ol>
    </section>
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('admin_common.All Car Brands') }}</h3>
        </div>
        <!-- /.box-header -->
        ...
        {!! csrf_field() !!}
            ...
            <div class="controls">
                ...
                <a href="{{ url('admin/carbrand/edit') }}" class="btn btn-primary btn-sm"><i class="fa fa-file-o"></i> {{ trans('admin_common.New Car Brand') }}</a>
                <a href="{{ url('admin/carbrand/import') }}" class="btn btn-primary btn-sm"><i class="fa fa-files-o"></i> {{ trans('admin_common.Import Car Brands from csv') }}</a>
            </div>
                    ...
                    <tbody>
                        @foreach($modelData as $k => $v)
                            <tr>
                                ...
                                <td><a href="{{ url('admin/carbrand/edit/' . $v['car_brand_id']) }}"><i class="fa fa-edit"></i> {{ trans('admin_common.Edit') }}</a></td>
                                <td><a href="{{ url('admin/carbrand/delete/' . $v['car_brand_id']) }}" class="text-danger need_confirm"><i class="fa fa-trash"></i> {{ trans('admin_common.Delete') }}</a></td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
