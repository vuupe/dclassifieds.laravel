...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">{{ trans('admin_common.Mail Ban') }}</li>
        </ol>
    </section>
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('admin_common.All Mail Bans') }}</h3>
        </div>
        <!-- /.box-header -->

        <form method="post" name="list_form" id="list_form" action="{{ url('admin/mailban/delete') }}">
        {!! csrf_field() !!}
            ...
            <div class="controls">
                ...
                <a href="{{ url('admin/mailban/edit') }}" class="btn btn-primary btn-sm"><i class="fa fa-file-o"></i> {{ trans('admin_common.New Mail Ban') }}</a>
            </div>
            ...
            <div class="box-body">
                ...
                <tbody>
                    <?foreach($modelData as $k => $v){?>
                        <tr>
                            <td>
                                <input type="checkbox" name="ban_email_id[]" value="<?=$v['ban_email_id']?>">
                            </td>
