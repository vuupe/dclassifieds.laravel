                    ...
                    <tr>
                        <td>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="padding: 10px; border-bottom: 1px solid #dddddd;">
                                        <h1 style="font-size: 18px;">{{ trans('cron.Hello') }} {{$ad->ad_puslisher_name}},</h1>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td width="50%" style="padding: 10px; border-bottom: 1px solid #dddddd; text-align: center;">{{ trans('cron.') }}</td>
                                    <td width="50%" style="padding: 10px; border-bottom: 1px solid #dddddd; text-align: center;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="border-top: 1px solid #dddddd; text-align: center; padding: 20px;">
                                        {{ trans('index_layout.copyright') }} &copy; {{ date('Y') }} <a href="{{ config('dc.site_url') }}">{{ config('dc.site_copyright_name') }}</a> {{ trans('index_layout.All rights reserved.') }}
                                    </td>
                                </tr>
                            </table>
